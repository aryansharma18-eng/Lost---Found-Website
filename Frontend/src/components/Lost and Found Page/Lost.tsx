...
const initialFormData: LostFormData = {
  name: "",
  itemName: "",
  description: "",
  lastSeenLocation: "",
...
const Lost = () => {
  const [formData, setFormData] = useState<LostFormData>(initialFormData);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (formData.proofImage) {
        ...
        imageData.append("file", formData.proofImage);
        imageData.append(
          "upload_preset",
          import.meta.env.VITE_CLOUDINARY_UPLOAD_PRESET
        );
        imageData.append("folder", "Lost_Items");
       ...
       *
       * The backend currently expects `studentId`,
       * so we keep that API field while using
      ...
      if (!response.ok) {
        throw new Error(
          result?.message || "Unable to submit your report."
        );
      }
    ...
    <main className="report-page">
      <div className="container report-container">
        ...
        <div className="report-header">
          <div className="report-header-icon lost-icon">
            <Search size={25} />
          </div>
          ...
          <div>
            ...
            <p>
              Give us a few details about your item so it can be
              easier to identify and recover.
            </p>
          </div>
        </div>
...
<section className="form-section">
  ...
  <div className="form-section-heading">
    ...
    <div>
      ...
      <p>
        Help narrow down where the item may have been lost.
      </p>
    </div>
  </div>
  ...
  <div className="form-grid">
    ...
    <div className="form-field">
      ...
      <small>
        Enter the place where you last remember having the item.
      </small>
    </div>
    ...
    <div className="form-field">
      ...
      <small>
        Select the date and approximate time when you last had the item.
      </small>
    </div>
          ...
          <section className="form-section">
            ...
            <div className="form-section-heading">
              ...
              <div>
                ...
                <p>
                  A photo can make it easier to identify your item.
                </p>
              </div>
            </div>
